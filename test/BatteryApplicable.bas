...
' ==================
'
Public Sub Battery(ByVal f As Applicable, ByVal x, ByVal y)
...
' -----
'
Private Sub TestApply(ByVal f As Applicable, ByVal x, ByVal y)

    Assert.AreEqual y, f.Apply(x)

End Sub
Private Sub TestPartial(ByVal f As Applicable, ByVal x, ByVal y)
...
End Sub
Private Sub TestDelay(ByVal f As Applicable, ByVal x, ByVal y)
